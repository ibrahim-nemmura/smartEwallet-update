...
import tdu.ibrahim.budget.firebase.models.UserSettings;
import tdu.ibrahim.budget.base.BaseFragment;
import tdu.ibrahim.budget.util.CalendarHelper;
import tdu.ibrahim.budget.util.CategoriesHelper;
import tdu.ibrahim.budget.models.Category;
import tdu.ibrahim.budget.ui.options.OptionsActivity;
import tdu.ibrahim.budget.util.CurrencyHelper;
import tdu.ibrahim.budget.R;
import tdu.ibrahim.budget.firebase.ListDataSet;
import tdu.ibrahim.budget.firebase.viewmodel_factories.UserProfileViewModelFactory;
import tdu.ibrahim.budget.firebase.viewmodel_factories.TopWalletEntriesViewModelFactory;
import tdu.ibrahim.budget.firebase.models.User;
import tdu.ibrahim.budget.libraries.Gauge;
